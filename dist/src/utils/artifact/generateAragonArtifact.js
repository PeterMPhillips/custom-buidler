...
function _generateAragonArtifact(arapp, abi, functions) {
    ...
    const appName = arappUtils_1.parseAppName(arapp);
...
function generateAragonArtifact(arapp, abi, functionsOrSourceCode, contractName) {
