...
async function updateApp({ appName, dao, repo, appServePort }, bre) {
    ...
    await _updateProxy({ implementationAddress: implementation.address, appName, dao }, bre.web3);
 ...
 */
async function _updateProxy({ implementationAddress, appName, dao }, web3) {
