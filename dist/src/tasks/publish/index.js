...
async function publishTask({ bumpOrVersion, existingContractAddress, managerAddress, ipfsApiUrl: ipfsApiUrlArg, onlyContent, verify, dryRun }, bre) {
...
`);
    ...
    logger_1.logMain(`Building app front-end at ${appSrcPath}`);
    ...
    artifact_1.validateArtifacts(distPath);
