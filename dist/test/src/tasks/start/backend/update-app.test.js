...
describe('update-app.ts', function () {
    ...
    before('deploy a dao', async function () {
        dao = await create_dao_1.createDao(this.env.web3, this.env.artifacts, daoFactoryAddress);
    });
    ...
    describe('when an app is created', function () {
        ...
        before('create app', async function () {
            ...
            await set_permissions_1.setAllPermissionsOpenly(dao, proxy, arapp, this.env.web3, this.env.artifacts);
